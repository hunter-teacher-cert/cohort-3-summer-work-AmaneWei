...
public class AlPractice{
  ...
  */
  public static ArrayList<Integer> buildRandomList(int size, int maxval){
    ...
    for (int i = 0; i < size; i++) {
      int num = rand.nextInt(maxval);
      data.add(num);
    }
    return data;//placeholder to compile.
  }
  ...
  */
  public static void removeValue(ArrayList<Integer> dataList, int valueToRemove){
    for (int i = 0; i < dataList.size(); i++) {
      if (valueToRemove == dataList.get(i)) {
        dataList.remove(i);
        i--;
      }
    }
  ...
  */
  public static ArrayList<Integer> sumLists(ArrayList<Integer>ListA,ArrayList<Integer>ListB){
    ...
    ArrayList<Integer> sumList = new ArrayList<Integer>(len);
  ...
  */
  ...
  public static void main(String[] args) {
    ...
    System.out.println("Build Random Array list of Size 10 and Max Val of 100");
    al = buildRandomList(10,100);
    System.out.println(al);

    System.out.print("\nSum of elements in Array List: ");
    ...
    System.out.print("\nSwap of elements 2 and 6 in Array List: \n");
    swapElements(al,2,6);
    System.out.println(al);
    ...
    al.set(2,5);
    al.set(3,5);
    System.out.println("Before: Added 5s to the Array list to remove");
    System.out.println(al);
    removeValue(al,5);
    System.out.println("\nAfter: Removed 5s");
    System.out.println(al);
    ...
    System.out.println("\nSum of List A and List B");
    ArrayList<Integer> sumList = sumLists(al, bl);
